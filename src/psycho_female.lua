...
imgs["idle_right1"]   = love.graphics.newImage("graphics/fem_idle_right1.png")
timings["idle_right1"]= timestep
frames["idle_right1"] = 26

imgs["idle_right2"]   = love.graphics.newImage("graphics/fem_idle_right2.png")
timings["idle_right2"]= timestep
frames["idle_right2"] = 18

imgs["idle_right3"]   = love.graphics.newImage("graphics/fem_idle_right3.png")
timings["idle_right3"]= timestep
frames["idle_right3"] = 39

imgs["idle_up1"]   = love.graphics.newImage("graphics/fem_idle_up1.png")
timings["idle_up1"]= timestep
frames["idle_up1"] = 1

imgs["idle_down1"]   = love.graphics.newImage("graphics/fem_idle_down1.png")
timings["idle_down1"]= timestep
frames["idle_down1"] = 1

function PsychoFemale(x, y, z)
